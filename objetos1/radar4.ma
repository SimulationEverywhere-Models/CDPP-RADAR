...
[pantalla]
% rule : 2 0 { (0,0,2) = 1.1 or (0,0,2) = 2.1 or (0,0,2) = 3.1 or (0,0,2) = 4.1 or (0,0,2) = 5.1 or (0,0,2) = 6.1 or (0,0,2) = 7.1 or (0,0,2) = 8.1 }
% rule : 4 0 { (0,0,2) = 1.2 or (0,0,2) = 2.2 or (0,0,2) = 3.2 or (0,0,2) = 4.2 or (0,0,2) = 5.2 or (0,0,2) = 6.2 or (0,0,2) = 7.2 or (0,0,2) = 8.2 }
rule : 2 0 { ((0,0,2) = 1.1 or (0,0,2) = 2.1 or (0,0,2) = 3.1 or (0,0,2) = 4.1 or (0,0,2) = 5.1 or (0,0,2) = 6.1 or (0,0,2) = 7.1 or (0,0,2) = 8.1) and 0 <= (0,0,1) and (0,0,1) <= 50 }
rule : 4 0 { ((0,0,2) = 1.2 or (0,0,2) = 2.2 or (0,0,2) = 3.2 or (0,0,2) = 4.2 or (0,0,2) = 5.2 or (0,0,2) = 6.2 or (0,0,2) = 7.2 or (0,0,2) = 8.2) and 0 <= (0,0,1) and (0,0,1) <= 50 }
rule : 2 0 { (0,0,2) > 88 }
